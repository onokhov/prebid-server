...
func (cfg *Configuration) setDerivedDefaults() {
	...
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderAdcel, "https://match.adcel.co/usersync?gdpr={{.GDPR}}&gdpr_consent={{.GDPRConsent}}&us_privacy={{.USPrivacy}}&r="+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Dadcel%26gdpr%3D{{.GDPR}}%26gdpr_consent%3D{{.GDPRConsent}}%26uid%3D%24%7BUUID%7D")
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderAdcelInmobi, "https://match.adcel.co/usersync?gdpr={{.GDPR}}&gdpr_consent={{.GDPRConsent}}&us_privacy={{.USPrivacy}}&r="+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Dadcel%26gdpr%3D{{.GDPR}}%26gdpr_consent%3D{{.GDPRConsent}}%26uid%3D%24%7BUUID%7D")
...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.adcel.endpoint", "http://dsp.adcel.co/hb")
	v.SetDefault("adapters.adcelinmobi.endpoint", "http://dsp.adcel.co/hb")
