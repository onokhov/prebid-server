...
func (cfg *Configuration) setDerivedDefaults() {
	...
	// openrtb_ext.BidderAdcel doesn't have a good default.
	// openrtb_ext.BidderAdcelinmobi doesn't have a good default.
...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.adcel.endpoint", "http://prebid.adcel.co/rtb")
	v.SetDefault("adapters.adcelinmobi.endpoint", "http://prebid.adcel.co/rtb")
